...
public class Recipe implements Iterable<Ingredient> {
	...
	public String getResultID() { return result; }
	...
	public int getSkillRankRequirement() { return skillRankRequirement; }
	...
	public boolean isResultIngredient() { return !ingredientItemTypes.isEmpty(); }
	...
	@Override public Iterator<Ingredient> iterator() {
	...
	private class IngredientIterator implements Iterator<Ingredient> {
		...
		@Override public Ingredient next() {
