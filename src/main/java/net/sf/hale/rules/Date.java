...
public class Date {
	...
	public void incrementRound() {  incrementRounds(1); }
	public void incrementMinute() { incrementMinutes(1); }
	public void incrementHour() { incrementHours(1); }
	public void incrementDay() { incrementDays(1); }
	public void incrementMonth() { incrementMonths(1); }
	
	public int getTotalRoundsElapsed() { return roundNumber; }
	...
	private String shortString(int months, int days, int hours, int minutes, int rounds) {
		...
		if (rounds != 0) {
			sb.append(rounds);
			if (rounds == 1) sb.append(" Round ");
			else sb.append(" Rounds ");
		}
