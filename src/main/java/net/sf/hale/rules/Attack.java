...
public class Attack {
    ...
    public void setFlankingBonus(int flankingBonus) {
    ...
    public void setFlankingAttack(boolean flankingAttack) {
        this.flankingAttack = flankingAttack;
    }
    ...
    public void setDefenderAC(int defenderAC) {
