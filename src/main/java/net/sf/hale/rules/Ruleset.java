...
public class Ruleset {
    ...
    public QuickbarGroup getQuickbarGroup(String id) {
        return quickbarGroups.get(id);
    }

    public Collection<QuickbarGroup> getAllQuickbarGroups() {
        return quickbarGroups.values();
    }
    ...
    public Quality getItemQuality(String id) {
        return itemQualities.get(id);
    }
    ...
    public RacialType getRacialType(String ref) {
        return racialTypes.get(ref);
    }
    ...
    public BaseWeapon getBaseWeapon(String ref) {
        return baseWeapons.get(ref);
    }

    public ArmorType getArmorType(String ref) {
        return armorTypes.get(ref);
    }

    public DamageType getDamageType(String ref) {
        return damageTypes.get(ref);
    }

    public Faction getFaction(String ref) {
        return factions.get(ref);
    }

    public Race getRace(String ref) {
        return races.get(ref);
    }

    public Role getRole(String ref) {
        return roles.get(ref);
    }

    public Skill getSkill(String ref) {
        return skills.get(ref);
    }
    ...
    public AbilitySelectionList getAbilitySelectionList(String id) {
        return abilitySelectionLists.get(id);
    }
