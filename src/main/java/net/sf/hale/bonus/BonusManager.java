...
public class BonusManager  {
	...
	public void remove(Bonus bonus) {
		...
		case WeaponProficiency:
			...
			break;
		case Skill:
		case AttackVsRacialType: case DamageVsRacialType: case ArmorClassVsRacialType:
		case ArmorTypeMovementPenalty: case ArmorTypeArmorPenalty: case ArmorTypeArmorClass:
		...
		case DamageImmunity: case DamageReduction:
		case DamageForWeaponType: case DamageForSpellType: case AttackForWeaponType:
