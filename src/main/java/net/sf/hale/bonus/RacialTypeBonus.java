...
public class RacialTypeBonus extends IntBonus implements BonusWithSuperType {
	...
	public String getRacialType() { return racialType; }

	@Override public String getSuperType() { return racialType; }
	
	@Override public RacialTypeBonus cloneWithReduction(int reduction) {
