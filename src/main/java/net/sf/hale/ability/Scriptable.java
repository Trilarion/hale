...
public class Scriptable implements Saveable {
	 ...
	 * {@link net.sf.hale.ScriptInterface}.  After that, each argument specified will
	 * be passed in turn
	 * 
	 ...
	 * The first argument passed to the function will be Game.scriptInterface (see
	 * {@link net.sf.hale.ScriptInterface}.  After that, the second argument will be the supplied argument
	 * 
