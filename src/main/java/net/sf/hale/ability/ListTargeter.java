...
public class ListTargeter extends Targeter {
	...
	/*
	 * (non-Javadoc)
	 * @see net.sf.hale.effect.Targeter#hasSelectedTargets()
	 */
	
	@Override public boolean hasSelectedTargets() {
	...
	/**
	 * @see net.sf.hale.ability.Targeter#setMousePosition(int, int, net.sf.hale.util.Point)
	 * 
	...
	@Override public boolean setMousePosition(int x, int y, Point gridPoint) {
