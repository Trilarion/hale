...
public class AbilitySlot implements Saveable {
	...
	public int getCooldownRoundsLeft() { return cooldownRoundsLeft; }
	...
	public int getActiveRoundsLeft() { return activeRoundsLeft; }
	...
	public boolean isEmpty() { return abilityID == null; }
	...
	protected boolean setAbility(Ability ability) {
		if (ability == null) return setAbility((String)null);
		else return setAbility(ability.getID());
	}
	 ...
	 * located at the Resource indicated by scriptID.
	 * 
	 * @return a new Aura with the parent of this AbilitySlot as creator
