 ...
 * 
 * Each effect will generally contain one or more {@link net.sf.hale.bonus.Bonus}es
...
public class Effect extends Scriptable implements Saveable, HasScriptState {
	...
	public static Effect load(SimpleJSONObject data, ReferenceHandler refHandler, EffectTarget target) throws LoadGameException {
		...
		} else if (data.containsKey("scriptLocation")) {
	...
	public BonusList getBonuses() { return bonuses; }
	...
	public int getRoundsRemaining() { return duration; }
	...
	public boolean removeOnDeactivate() { return removeOnDeactivate; }
