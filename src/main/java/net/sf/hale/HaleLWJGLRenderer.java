...
public class HaleLWJGLRenderer extends LWJGLRenderer {
	...
	@Override public Texture loadTexture(URL url, String formatStr, String filterStr) throws IOException {
	...
	@Override public void clipEnter(int x, int y, int w, int h) {
	...
	@Override public void clipEnter(Rect rect) {
