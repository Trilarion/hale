...
public class WeaponTemplate extends EquippableItemTemplate {
	...
	@Override public Weapon createInstance() {
	...
	public Type getWeaponType() { return type; }
	...
	public Handed getHanded() { return handed; }
	...
	public boolean threatensAoOs() { return threatensAoOs; }
	 ...
	 * additional damage types via bonuses (see {@link net.sf.hale.bonus.StandaloneDamageBonus})
	...
	public int getCriticalThreat() { return criticalThreat; }
	...
	public int getMinStrengthBonus() { return minStrengthBonus; }
	
	@Override public boolean hasPrereqsToEquip(Creature parent) {
